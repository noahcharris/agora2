...

{
  ...
  zh: '完成后请点击“完成”',
  fr: 'Placez un point! Cliquer quand finis.',
  ...
  zh: '你的邮箱不会被泄露给其他用户',
  fr: "Votre email n'est jamais affiche",
  ...
  fr: "l'origine ne jeux pas être change une fois qu'elle est mise en place",
  ...
  zh: '密码不一致',
  fr: 'la confirmation du mot de passe set incorrecte',
  ...
  zh: '该用户不在数据库中',
  fr: "ne pouvons pas trouver l'utilisateur dans la base de donnée",
  ...
  zh: '成功更新邮箱',
  fr: "l'email n'a pa pu être mettre a jour avec succès",
  ...
  ar: 'كلمة محدثة بنجاح',
  zh: '密码成功更新',
  fr: 'mot de passe est mis a jour avec succès',
  ...
  zh: '位置成功更新',
  fr: 'Localisation set mis a jour avec succès',
  ...
  zh: '发送好友申请',
  fr: 'envoyez la demande de contacts',
  ...
  zh: '用户名不能包括“@”',
  fr: "nom d'utilisateur ne peux pas contenir '@'",
  ...
  zh: '这个用户名字已被使用',
  fr: "le nom d'utilisateur set deja pris",
  ...
  zh: '文件大小不能超过10MB',
  fr: 'Soyez sur sue le dossier ne depasse pas 10MB',
  ...
  zh: '成功创建位置',
  fr: 'Localisation cree avec succès',
  ...
  zh: '你的位置离母城市太远',
  fr: 'la Localisation est trop loin de la cite parente',
  ...
  zh: '你的频道处在过于下级的运算等级',
  fr: 'La chaine set trop profondemment emboite',
  ...
  zh: '你的位置必须是一个城市',
  fr: 'La Localisation doit apartenir a une cite',
...

{
  ...
  ar: 'لا يتطابق تأكيد كلمة',
  zh: '两次输入的密码不一致',
  fr: "la confirmation du mot de passe n'est pas correcte",
  de: 'Passwort ueberprufen! Sie muessen dass gleiche Passwort zweimal eingeben um es zu bestaetigen.',
  ja: ' パスワード確認が一致しません',
  ...
  zh: '频道无法显示:(',
  fr: "la chaine n'est pas disponible",
  ...
  zh: '频道名不能包含 “/”',
  fr: 'le nom de la chaine ne peux pas contenir "/"',
  ...
  ar: 'موقع غير متوفر',
  zh: '位置无法显示',
  fr: "la location n'est pas disponible",
  ...
  zh: '位置名字不能包含 “/”',
  fr: 'le nom de la location ne peux pas contenir "/"',
  ...
  zh: '用户名不能包含 “@”',
  fr: "le nom d'utilisateurs ne peux pas contenir '@'",
  de: 'Nutzername darf nicht ‘@’ enthalten',
  ja: 'ユーザー名に＠は使用できません',
  ...
  zh: '您必须登陆以发表回复',
  fr: 'vous devrez etres connecte pour pouvoir repondre',
  ...
  zh: '你的母频道必须以“All“开始',
  fr: 'la chaine parent doit commence avec "ALL"',
  ...
  zh: '请输入验证码',
  fr: "completez CAPTCHA s'il vous plait",
  ...
  zh: '你必须输入一个属于你频道的名字',
  fr: 'Il faut entrer un nom pour votre chaine',
  ...
  zh: '你必须选择一个有效的母城市',
  fr: 'il faut choisir une ville parent valid',
  ...
  zh: '你必须输入一个你的位置的名字',
  fr: 'il faut choisir un nom pour la Localisation',
  ...
  ar: 'موقع متاح',
  zh: '可用位置:)',
  fr: 'la Localisation est disponible',
  ...
  zh: '请在地图上指出一个点',
  fr: 'placer un point sur la carte',
  ...
  zh: '你必须验证你的邮箱来创建一个位置',
  fr: "il faut verifier la connexion de l'email pour créer une Localisation",
  ...
  zh: '你必须验证你的邮箱来创建一个频道',
  fr: "il faut verifier l'email pour cree la chaine",
  ...
  zh: '你必须登陆来以朋友排列话题顺序',
  fr: 'il faut etre connecte pour classifier les sujets par amis',
  ...
  zh: '你必须登陆来创建一个话题',
  fr: 'il faut être connecte pour cree un sujet',
  ...
  zh: '你必须提供大标题或者内容',
  fr: 'il faut fournir un titre ou du contenu',
  ...
  zh: '你必须登陆以查看你的个人资料',
  fr: 'il faut etre connecte pour voir votre profil',
  ...
  zh: '你必须登陆以查看设定',
  fr: 'il faut être connecte pour avoir accès aux Menu',
  ...
  zh: '你必须登陆以查看信息',
  fr: 'il faut etre connecte pour voir les messages',
  ...
  zh: '没有相关的搜索结果',
  fr: "la recherché n'a pas retourner de donnees",
  ...
  zh: '用户名不能包含 “@“',
  fr: "le nom d'utilisateur ne peut pas contenir '@'",
  ...
  zh: '请输入一个有效的来源',
  fr: "entrez un nom d'origine valid",
  ...
  zh: '请输入一个有效的现在来源',
  fr: 'entrez une location courante valid',
  ...
  zh: '确认联系人申请',
  fr: 'Confirmez la demande de contacte',
  de: 'Kontaktanfrage annehmen',
  ja: '連絡先追加リクエスト確認',
  ...
  en: "Don't see your city? Please email us the name at egoraco@gmail.com and we will add it into our database.",
  ar: 'لا ترى مدينتك ؟ يرجى مراسلتنا على اسم في egoraco@gmail.com وسوف نقوم إضافته إلى قاعدة البيانات الخاصة بنا .',
  zh: '没有你的城市？请将城市名发送到我们的邮箱egoraco@gmail.com，我们会将名字加入数据库中',
  fr: ' Vous ne voyez pas la cite? Envoyez nous un email au nom de egoraco@gmail.com et nous vous ajouterons dan notre base de donnée.',
  de: 'Finden Sie Ihre Stadt nicht? E-mailen Sie uns unter egoraco@gmail.com um die Database zu aktualisieren.',
  ja: 'お住まいの街が見つかりませんかegoraco@gmail.comまでEメールでご連絡ください。データベースに追加致します',
  pt: 'Não vê sua cidade? Por favor mande um email para egoraco@gmail.com e adicionaremos na nossa base de dados',
  ru: 'Не находите город? Пожалуйста, свяжитесь нами по egoraco@gmail.com и мы добавим его в базу.',
  es: 'No ves tu ciudad? Por favor envianos el nombre por correo electrónico a egoraco@gmail.com y lo agregaremos a nuestra base de datos',
},{
  en: 'you two are already contacts',
  ar: 'كنت بالفعل اتصالات مع هذا المستخدم',
  zh: '你们已经是联系人了',
  fr: 'Vous deux sommes deja contacts.',
  ...
  zh: '用户名不能超过35个字符',
  fr: "Le nom de l'utilisateur doit être au moin 35 caractères ou moin",
  ...
  zh: '查看邀请码',
  fr: "regarded les code d'invitations",
  ...
  ar: 'ربط حساب تويتر',
  zh: '连接到twitter账号',
  fr: 'connectez au compte twitter',
  ...
  fr: 'vous aver deja associez un compte twitter aver voter profil',
  ...
  fr: 'ce compete twitter set deja associe aver un compte Egora',
  ...
  fr: 'si vous corrigais voter compte tweeter, Egora placera vos dernier tweets et les placer dans la location courante sous la chaine All/Twitter)',
...

{
  ...
  zh: "地点名称不能包含'/'",
  fr: 'La Localisation ne peut pas contenir "/"',
  ...
  ar: 'لا تحتوي اسم الموضوع: "/"',
  zh: "主题不能包含'/'",
  fr: 'La Chaine ne peut pas contenir "/"',
