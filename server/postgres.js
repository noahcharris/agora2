...
module.exports.createUser = function(username, passhash, salt, location, about, email, cb) {
  client.query("INSERT INTO users (type, username, passhash, salt, location, about, email, image) "
    +"VALUES ('User', $1, $2, $3, $4, $5, $6, 'https://s3-us-west-2.amazonaws.com/agora-image-storage/Anonymous-Seal.jpg');",
     [username, passhash, salt, location, about, email], function(err, result) {
      if (err) {
